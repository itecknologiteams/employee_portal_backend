...
router.post('/payroll-sheet/upload', payrollExcelUpload.single('file'), payrollController.uploadPayrollSheet)
router.post('/gross-salaries', payrollController.addGrossSalary)

// ---------- Payroll periods ----------
router.get('/periods', payrollController.listPeriods)
router.get('/periods/check-unclosed', payrollController.checkUnclosed)
...
router.post('/periods/:id/overrides/upload', payrollExcelUpload.single('file'), payrollController.uploadPeriodOverrides)
router.post('/periods/:id/apply-deductions-sheet', payrollExcelUpload.single('file'), payrollController.applyDeductionsSheet)
...
router.get('/tax-slabs/versions', payrollController.listTaxSlabVersions)
router.get('/tax-slabs/versions/:id', payrollController.getTaxSlabVersionById)
router.post('/tax-slabs/versions', payrollController.createTaxSlabVersion)
router.put('/tax-slabs/versions/:id/active', payrollController.setActiveTaxSlabVersion)
router.delete('/tax-slabs/versions/:id', payrollController.deleteTaxSlabVersion)
